...
public class BlueFarDetectionPipeline extends OpenCvPipeline {
    ...
    public static int leftRectTopX = 80 ,leftRectTopY = 50;
    public static int leftRectBottomX = 180 ,leftRectBottomY = 150;

    public static int middleRectTopX = 260 ,middleRectTopY = 70;
    public static int middleRectBottomX = 360 ,middleRectBottomY = 155;
