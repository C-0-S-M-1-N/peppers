...
@Autonomous(group = "Autos", preselectTeleOp = "pipers \\uD83C\\uDF36", name = "NotShitBlueFar")
@Config
public class NotShitBlueFar extends LinearOpMode {
    ...
    public static double OFFSET_X = 22.5;
    public static double OFFSET_Y = 79.5 - 23 + 39;
    AprilTagDetectionPipeline pipeline;

    int caz;
    public static double init_x = 0 , init_y = 0, init_heading = 0;
    public static double LPreload_x = 31, LPreload_y = 8, LPreload_heading = -90;
    public static double MPreload_x = 37, MPreload_y = -4, MPreload_heading = -90;
    public static double RPreload_x = 37, RPreload_y = -8, RPreload_heading = 0;

    public static double LBackdrop_x = 20, LBackdrop_y = 94.5, LBackdrop_heading = 90;
    public static double MBackdrop_x = 25, MBackdrop_y = 95.5, MBackdrop_heading = 90;
    public static double RBackdrop_x = 34, RBackdrop_y = 95.5, RBackdrop_heading = 90;
    ...
    private Pose2d backdropDetection = new Pose2d(23, 85, Math.toRadians(90));
    private Pose2d againStack = new Pose2d(50, -16.5, Math.toRadians(90));
    private Pose2d transitFar = new Pose2d(stack.getX(), 61, Math.toRadians(90));
    private Pose2d transitClose = new Pose2d(stack.getX(), 80, Math.toRadians(90));
    private Controls c;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while(opModeIsActive() && !isStopRequested()){
            ...
            if(TO_RELOCALIZE) {
                ...
                } else if(clock.seconds() - startTime >= 21){
                    TO_RELOCALIZE = false;
                    new Thread(() -> {
                        camera.closeCameraDevice();
                    }).start();
        ...
        public TrajectorySequence chipiChapa() {
            if(caz == 3) return mecanumDrive.trajectorySequenceBuilder(new Pose2d(STACK.getX() - 4, STACK.getY(), STACK.getHeading())).forward(3).back(3).build();
