...
public class RedFarDetectionPipeline extends OpenCvPipeline {
    ...
    public static int rightRectTopX = 230 , rightRectTopY = 50;
    public static int rightRectBottomX = 310 , rightRectBottomY = 150;

    public static int middleRectTopX = 10 ,middleRectTopY = 70;
    public static int middleRectBottomX = 100 ,middleRectBottomY = 150;
