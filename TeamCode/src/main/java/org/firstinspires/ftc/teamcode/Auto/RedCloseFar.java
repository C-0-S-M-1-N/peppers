...
public class RedCloseFar extends LinearOpMode {
    ...
    public static Pose2d
            ...
            MiddleYellow = new Pose2d(40, -32.8, Math.toRadians(234)),
    ...
    BackDropGate = new Pose2d(51, 5, Math.toRadians(270)),
            StackGate = new Pose2d(51.5, 43, Math.toRadians(270)),
            Stack = new Pose2d(50, 76, Math.toRadians(270)),
            Stack2 = new Pose2d(41.5, 75.5, Math.toRadians(291)),
            Backdrop = new Pose2d(42, -30, Math.toRadians(243));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RedCloseDetectionPipeline detector = new RedCloseDetectionPipeline(ControlHub.telemetry, true);
...
//                    OutTakeMTI.elevator.setTargetPosition(3.5 * OutTakeMTI.STEP);
        ...
        TrajectorySequence goToStackFromPreloadM = drive.trajectorySequenceBuilder(middle.end())
                ...
                .setVelConstraint(SampleMecanumDriveCancelable.getVelocityConstraint(58, 5, DriveConstants.TRACK_WIDTH))
        ...
        TrajectorySequence goToBackdrop = drive.trajectorySequenceBuilder(Stack)
                ...
                .setReversed(false)
                .setAccelConstraint(SampleMecanumDriveCancelable.getAccelerationConstraint(60))
                .setVelConstraint(SampleMecanumDriveCancelable.getVelocityConstraint(70, 4, DriveConstants.TRACK_WIDTH))
                .splineToSplineHeading(BackDropGate, Math.toRadians(-90))
                .addTemporalMarker(() -> {
                    intakeActive = 0;
                })
        ...
        TrajectorySequence goToStack = drive.trajectorySequenceBuilder(goToBackdrop.end())
                ...
                .setVelConstraint(SampleMecanumDriveCancelable.getVelocityConstraint(65, 5, DriveConstants.TRACK_WIDTH))
                .setAccelConstraint(SampleMecanumDriveCancelable.getAccelerationConstraint(58))
                .splineToSplineHeading(StackGate, Math.toRadians(90))
                .addTemporalMarker(() -> {
                    intake.setPixelStackPosition(pixelsInStack);
                    intakeActive = 1;
        ...
        TrajectorySequence goToStack2 = drive.trajectorySequenceBuilder(goToBackdrop2.end())
                ...
                .setVelConstraint(SampleMecanumDriveCancelable.getVelocityConstraint(68, 5, DriveConstants.TRACK_WIDTH))
...
//        }
        ...
        location = RedCloseDetectionPipeline.Location.MIDDLE;
        drive.followTrajectorySequenceAsync(middle);
